...
const b64Path = 'D:/vibe projects/dsh_demo/reading-mode-pkg/assets/avatar2.base64.txt'
const client = fs.readFileSync(clientPath, 'utf8')
const b64 = fs.readFileSync(b64Path, 'utf8').trim()
if (client.indexOf('__AVATAR2_B64__') < 0) {
  console.error('placeholder not found in client.js')
  process.exit(1)
}
const out = client.replace('__AVATAR2_B64__', b64)
